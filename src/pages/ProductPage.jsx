		...
		<>
			...
			<section className="container mx-auto mb-36">
				<div className="   flex  my-8 gap-x-8 flex-col md:flex-row ">
					...
					<div className="flex-1 flex-col bg-white p-8 shadow-md rounded-xl">
						...
						<div className="flex gap-2">
							<span className="text-gray-500 hover:text-gray-900 px-4 py-1 border cursor-pointer hover:border-black transition-all">
								M
							</span>
							<span className="text-gray-500 hover:text-gray-900 px-4 py-1 border cursor-pointer hover:border-black transition-all">
								XL
							...
							<>
								<div className="flex mt-4  gap-4">
									...
									<div className="flex gap-3 ">
										<ul className="hover:p-[5px] transition-all hover:border border-black h-7 w-7 rounded-full cursor-pointer">
				...
				<div className="mt-24">
					...
					<div className="shadow-md bg-white p-6 text-gray-400 text-sm rounded-lg leading-7">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus
						corrupti est harum soluta laborum, placeat maxime neque illo alias
						rerum! Tempora architecto rem asperiores unde ipsam ullam a maiores
						rerum voluptatum fugiat eveniet eaque, quia, ex ratione distinctio
						illo recusandae voluptas cupiditate? Cumque, amet voluptatem? Ullam
						nemo sapiente necessitatibus. Aliquid dolorem ullam impedit
						provident! Asperiores, perspiciatis! Repellendus eos voluptatibus
						exercitationem suscipit dolor similique iusto nulla fugiat est
						molestiae, quis sapiente repudiandae commodi, officiis saepe neque
						illo non quasi accusantium quidem.
					</div>
				</div>
				<div className="my-24">
					<h3 className="font-semibold mb-4 text-2xl  text-gray-700">
